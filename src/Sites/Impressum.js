...
export default function Impressum() {
    ...
    return <div className='defaultPageContainer ImpressumContainer'>
        ...
        Musterstraße 1<br />
        123456 Musterstadt</p>

        <h3>Kontaktdaten:</h3>
        <p>E - Mail: max@mustermann.com <br />
        Telefon: 0123456789</p>

        <br></br>

        <p>Geschäftsführer: Max Mustermann <br />
        Sitz und Registergericht: München HRB 123456 <br />
        Ust.- Id.- Nr.: DE123456789</p>
        ...
        <p>Die Inhalte des Internetauftritts wurden mit größtmöglicher Sorgfalt und nach bestem Gewissen erstellt. Dennoch übernimmt der Anbieter dieser Webseite keine Gewähr für die Aktualität, Vollständigkeit und Richtigkeit der bereitgestellten Seiten und Inhalte.
    ...
    Für die Inhalte und Richtigkeit der bereitgestellten Informationen ist der jeweilige Anbieter der verlinkten Webseite verantwortlich. Zum Zeitpunkt der Verlinkung waren keine Rechtsverstöße erkennbar. Bei Bekanntwerden einer solchen Rechtsverletzung wird der Link umgehend entfernen. </p>
        ...
        <h3>4. Datenschutz</h3>
        <p>Durch den Besuch des Internetauftritts können Informationen (Datum, Uhrzeit, aufgerufene Seite) über den Zugriff auf dem Server gespeichert werden. Es werden keine personenbezogenen (z. B. Name, Anschrift oder E-Mail-Adresse) Daten, gespeichert.
